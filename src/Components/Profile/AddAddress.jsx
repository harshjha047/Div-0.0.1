...
function AddAddress() {
  ...
  return (
    <div className="border border-gray-700 m-auto max-w-lg w-full rounded-lg p-4 mb-4">
          ...
          <div>
            <p className="text-white font-medium w-full">
              ...
              <select
                ...
                value={label}
                className="bg-[#0000002c]  px-2 py-1"
              >
        ...
        <div className="text-gray-300 text-sm space-y-1">
          <p>
            <input
              ...
              value={street}
              type="text"
              className="bg-[#00000034] px-3 py-2 my-3 mx-1 rounded"
              placeholder="street"
            />
            ,
            <input
          ...
          <p>
            <input
              ...
              value={city}
              type="text"
              className="bg-[#00000034] px-3 w-[150px] my-3  py-2 mx-1 rounded"
              placeholder="city"
            />
            ,
            <input
